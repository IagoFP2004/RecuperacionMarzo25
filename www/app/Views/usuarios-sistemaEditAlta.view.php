            ...
            <form action="" method="post">
                ...
                <div class="row">
                    <div class="mb-3 col-sm-6">
                        ...
                        <input class="form-control" id="username" type="text" name="username" placeholder="MyUsername" value="<?php echo $input['nombre'] ?? ''?>">
                    ...
                    <div class="mb-3 col-sm-4">
                        ...
                        <select class="form-control select2-container--default" name="id_rol">
                            <?php foreach ($roles as $rol){ ?>
                                <option value="<?php echo $rol['id_rol'] ?>" <?php echo (isset($input['id_rol']) && $input['id_rol'] == $rol['id_rol']) ? 'selected':'' ?>><?php echo $rol['rol'] ?></option>
                            <?php }?>
                        </select>
                    ...
                    <div class="mb-3 col-sm-2">
                        ...
                        <p class="text-danger"><?php echo $error['idioma'] ?? ''?></p>
                    </div>
